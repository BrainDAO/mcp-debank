# Screenshots referenced by the project README

Drop the following PNGs into this folder. The main README links to them with
relative paths under `docs/images/`.
...
Use PNG, ~1500-2400 px wide for crisp display on Retina. Keep file sizes under
~500 KB each (compress with tools like `pngquant` if needed).
